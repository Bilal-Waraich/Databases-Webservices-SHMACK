...
<body>
    <header>
        <div class="header-content">
            <img src="img/logo.png" alt="SHMACK Logo" class="logo">
            <h1>SHMACK</h1>
        </div>
        <nav class="navbar">
    ...
    <section class="entity-input">
        ...
        <form action="submit_user.php" method="POST" class="form-style">
            ...
            <div class="form-group">
                <label for="permissions_rights">Permissions/Rights:</label>
                <input type="text" id="permissions_rights" name="permissions_rights" required>
            </div>
            <div class="form-group">
