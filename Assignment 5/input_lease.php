        ...
        <form action="submit_lease.php" method="POST">
            ...
            <div class="form-group">
                ...
                <select id="costcenter_id" name="costcenter_id" required>
                    ...
                    <?php include 'fetch_data.php'; // Include the PHP file to fetch cost center options ?>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <select id="subsidiary_id" name="subsidiary_id" required>
                    <option value="">Select</option>
                    <?php include 'fetch_data.php'; // Include the PHP file to fetch subsidiary options ?>
                </select>
            </div>
