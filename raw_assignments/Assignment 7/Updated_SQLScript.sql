...
CREATE TABLE UserManagement (
    UserManagement_ID INT PRIMARY KEY AUTO_INCREMENT,
    Username VARCHAR(50) UNIQUE NOT NULL,
    PasswordHash VARCHAR(255) NOT NULL,
    AD_ID INT NOT NULL,
    FOREIGN KEY (AD_ID) REFERENCES Users(AD_ID)
);
...
-- Sample entries with simpler passwords and hashing
INSERT INTO UserManagement (Username, PasswordHash, AD_ID)
VALUES 
    ('admin', SHA2('admin123', 256), 1001),
    ('guest', SHA2('guest123', 256), 1002);
