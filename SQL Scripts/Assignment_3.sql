CREATE TABLE CostCenter (
    CostCenter_ID INT PRIMARY KEY NOT NULL UNIQUE,
    CostCenter_Name VARCHAR(255),
    Budget DECIMAL(15, 2)
);

CREATE TABLE Subsidiaries (
    Subsidiary_ID INT PRIMARY KEY NOT NULL UNIQUE,
...
CREATE TABLE Leases (
    Lease_ID INT PRIMARY KEY NOT NULL UNIQUE,
...
CREATE TABLE Users (
    AD_ID INT PRIMARY KEY NOT NULL UNIQUE,
    Email VARCHAR(255),
    Name VARCHAR(255),
    Address VARCHAR(255),
    Role VARCHAR(50),
